...
function websiteOrigin(requestHeaders: Headers) {
  ...
  const host = allowedHosts.has(hostname) ? requestedHost : "127.0.0.1:4102";
  ...
  origin.port = origin.hostname === "localhost" || origin.hostname.startsWith("127.") ? "5000" : "";
...
export async function GET() {
  ...
  destination.searchParams.set("portal", "instructor");
