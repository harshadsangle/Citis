        ...
        <div className="workspace-content">
           ...
           <div className="breadcrumb-bar">
            ...
            {!error && !loading && canLoad && visibleRecords.length === 0 && (
               <div className="state-box empty-box"><div className="state-symbol soft">+</div><div><strong>No {labelFor(activeKind).toLowerCase()} yet</strong><p>Start building this part of the learning hierarchy.</p><button className="text-button" type="button" onClick={openCreate}>{activeKind === "courses" ? "Create Course" : "Create the first one →"}</button></div></div>
            )}
