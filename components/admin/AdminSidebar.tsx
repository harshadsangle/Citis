      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-white/10 px-5">
          <Link href="/admin" className="flex items-center gap-2.5" onClick={onClose}>
            <span className="grid size-8 place-items-center rounded-lg bg-white font-heading font-bold text-[#0F4C81]">
              C
            </span>
            <span className="font-heading text-sm font-semibold tracking-tight">CITIS Admin</span>
          </Link>
          <button
            className="rounded-md p-1.5 text-blue-100 hover:bg-white/10 lg:hidden"
            onClick={onClose}
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4" aria-label="Admin navigation">
          <p className="px-3 pb-2 text-[10px] font-semibold tracking-[0.18em] text-blue-200/70 uppercase">
            Workspace
          </p>
