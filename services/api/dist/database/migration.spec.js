...
(0, node_test_1.default)("certificate migration defines scoped issuance, verification, and export permissions", () => {
    ...
    strict_1.default.match(certificateMigration, /UNIQUE \(tenant_id, enrollment_id\)/);
    strict_1.default.match(certificateMigration, /UNIQUE \(certificate_number\)/);
    strict_1.default.match(certificateMigration, /UNIQUE \(verification_id\)/);
    strict_1.default.match(certificateMigration, /lms_certificates_enrollment_scope_fk/);
    strict_1.default.match(certificateMigration, /lms\.certificate\.export/);
    strict_1.default.match(certificateMigration, /013_lms_certificates/);
});
