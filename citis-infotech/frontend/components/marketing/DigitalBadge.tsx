...
export function DigitalBadge({ certification }: { certification: GlobalCertification }) {
  ...
  return (
    <div className="group/badge relative mx-auto aspect-square w-full max-w-[15rem] overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#0f4c81] via-[#123d5c] to-[#092c46] p-2 shadow-[0_22px_50px_rgba(15,76,129,0.2)] transition-transform duration-300 group-hover/badge:-translate-y-1">
      <div className="absolute -right-12 -top-12 size-36 rounded-full bg-[#f9e8a2]/35 blur-2xl" />
      ...
      <div className="relative flex size-full flex-col items-center justify-between rounded-[1.55rem] border border-white/25 bg-[linear-gradient(160deg,#fafdfe_0%,#e8f4f8_100%)] px-5 py-5 text-center">
        ...
        <div className="w-full">
          <p className="text-[0.6rem] font-bold tracking-[0.26em] text-[#c49319] uppercase">Digital Badge</p>
        ...
        <div className="flex items-center gap-1.5 text-[0.58rem] font-semibold text-[#0f4c81]">
          <BadgeCheck className="size-3.5 text-[#c9930f]" />
          Verified credential
        </div>
      </div>
    </div>
