...
export const GLOBAL_CERTIFICATIONS: GlobalCertification[] = [
  ...
  },
  {
    ...
    overview:
      "IC3 Digital Literacy Global Standard 6 (GS6) is the latest version of the IC3 Digital Literacy program. It addresses current computing concepts, including cloud and mobile technologies, and helps learners of all ages validate their understanding of digital literacy. Candidates demonstrate the ability to select and use appropriate research, productivity, collaboration and communication tools; find reliable information; create content; communicate safely; and identify credibility and bias in modern digital environments.",
    skills: [
      "IC3 Digital Literacy Level 1, Level 2 and Level 3 exams",
      "Research, productivity, collaboration and communication tools",
      "Reliable information, content creation and safe communication",
      "Credibility, bias and responsible participation in digital environments",
    ],
    benefits: [
      "Three stackable exams award an individual certificate at the basic, intermediate and advanced levels.",
      "Level 1 measures fundamental concepts and essential components.",
      "Level 2 requires working knowledge of each of the seven skill groups.",
      "Level 3 validates advanced digital literacy and a technical foundation for further study and employment.",
    ],
    examDetails: [
      "Exam structure: three certifications — IC3 Digital Literacy Level 1, Level 2 and Level 3.",
      "Objective domains: seven digital literacy domains assessed across the three levels.",
      "Each level measures a progressively deeper understanding of the program objectives.",
    ],
    credentialDetails: [
      "Each successfully completed GS6 exam awards its own certificate.",
      "Passing all three Global Standard 6 exams awards the IC3 Digital Literacy Master Certification and Master Badge.",
    ],
    careerRelevance:
      "GS6 provides a current, stackable digital-literacy foundation for learners entering education, employment or more specialised technology training. The skills apply across almost every school and career pathway.",
    suitableFor: "Primary, secondary and post-secondary learners, jobseekers and digital upskilling groups",
    digitalBadging: {
      ...IC3_DIGITAL_BADGING_DETAILS,
      badgeName: "IC3 Digital Certification badge and GS6 Master Badge",
    },
    ic3Credential: {
      badgeName: "IC3 Digital Certification badge",
  ...
  },
  {
    ...
    overview:
      "IC3 Digital Literacy Global Standard 5 (GS5) is a previous version of the IC3 Digital Literacy program. It is comprised of three exams — Computing Fundamentals, Living Online and Key Applications — and validates concepts and skills that apply to almost any school or career pathway.",
    skills: [
      "Computing Fundamentals",
      "Key Applications",
      "Living Online",
      "Foundational digital skills for study, work and further learning",
    ],
    benefits: [
      "Validate a broad foundation of digital literacy through three focused exams.",
      "Demonstrate practical understanding of computer concepts and common applications.",
      "Build confidence working in Internet and networked environments.",
      "Use an internationally recognised credential to support education and career progression.",
    ],
    examDetails: [
    ...
    credentialDetails: [
      ...
      "The credential provides evidence of practical digital skills for students and jobseekers.",
    ],
    careerRelevance:
      "GS5 helps students and jobseekers show a practical baseline in computer fundamentals, productivity applications and online work — capabilities that transfer across education and almost every modern workplace.",
    suitableFor: "Students, jobseekers and learners validating an established digital-literacy foundation",
    digitalBadging: {
      ...IC3_DIGITAL_BADGING_DETAILS,
      badgeName: "IC3 Digital Certification badge",
    },
  ...
  },
  {
    ...
    overview:
      "With a focus on younger demographics, the IC3 Spark certification addresses the same foundational concepts as the IC3 Digital Literacy Certification. It is designed for younger children who may be new to computers and the Internet or who lack a solid foundation in digital concepts.",
    skills: [
      "Operating system basics",
      "Computer hardware and concepts",
      "Computer software and common application features",
      "Word processing, spreadsheet and presentation activities",
      "Browsers, digital communication and online research",
      "Digital citizenship and safe computing",
    ],
    benefits: [
      "Introduce foundational computer concepts in an age-appropriate certification.",
      "Build confidence with common applications and digital communication.",
      "Develop early habits for safe, responsible and informed technology use.",
      "Create a recognised starting point for continued digital-literacy learning.",
    ],
    examDetails: [
      "Objective domains: operating system basics, hardware and concepts, software and concepts, common application features, productivity activities, browsers, digital communication, digital citizenship, safe computing and research fluency.",
      "The certification covers foundational skills in word processing, spreadsheets, presentations and Internet use.",
      "IC3 Spark certification exams are available in select languages.",
    ],
    credentialDetails: [
      "Successful completion awards the IC3 Spark certification.",
      "The credential is designed to validate foundational digital concepts for younger learners.",
    ],
    careerRelevance:
      "IC3 Spark establishes the digital habits learners need for school, future learning and their first technology-enabled environments. It creates a clear foundation for progression into broader IC3 Digital Literacy certifications.",
    suitableFor: "Younger learners and students who are new to computers or the Internet",
    digitalBadging: {
      ...IC3_DIGITAL_BADGING_DETAILS,
      badgeName: "IC3 Digital Certification badge",
    },
  ...
  },
  {
    ...
    overview:
      "IC3 Fast Track is a digital literacy skills assessment that can be used to gauge the skill set of incoming students or job candidates. Based on the globally recognised IC3 Digital Literacy Certification, it helps assess an individual's ability to perform in any environment where the use of technology is required. Fast Track is available on the GMetrix learning platform.",
    skills: [
      "Digital literacy skills assessment",
      "Readiness of incoming students and job candidates",
      "Ability to perform in technology-required environments",
      "GMetrix learning platform assessment",
    ],
    benefits: [
      "Identify digital-literacy strengths and development needs quickly.",
      "Help institutions and employers understand incoming learner or candidate readiness.",
      "Use an assessment based on the globally recognised IC3 Digital Literacy framework.",
      "Support targeted learning decisions before a full certification pathway.",
    ],
    examDetails: [
    ...
    credentialDetails: [
      ...
      "The outcome helps institutions and employers identify appropriate next steps for learning or certification.",
    ],
    careerRelevance:
      "Fast Track helps education and hiring teams make better decisions about digital readiness, while giving learners a clear starting point for targeted training and future IC3 certification.",
    suitableFor: "Schools, colleges, employers and teams assessing incoming learners or candidates",
    digitalBadging: {
      ...IC3_DIGITAL_BADGING_DETAILS,
      badgeName: "IC3 Digital Literacy badge reference",
    },
    ic3Credential: {
      badgeName: "IC3 Digital Certification badge reference",
      imageUrl: IC3_BADGE_IMAGE,
