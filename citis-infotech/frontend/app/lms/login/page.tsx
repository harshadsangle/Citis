  ...
  return (
    <section className="relative isolate min-h-[calc(100vh-var(--header-height))] overflow-hidden py-16">
      ...
      <div className="container-site grid items-stretch gap-8 lg:grid-cols-2">
        ...
        <div className="surface flex items-center rounded-3xl p-6 sm:p-10"><div className="mx-auto w-full max-w-md"><Link href="/lms" className="inline-flex items-center gap-2 text-sm font-semibold text-primary"><ArrowLeft className="size-4" />Back to LMS</Link><h1 className="mt-9 font-heading text-3xl font-semibold">Welcome to your learning space</h1><p className="mt-3 text-sm leading-6 text-muted-foreground">Sign in to continue your CITIS learning journey.</p><div className="mt-8"><LmsLoginForm /></div><p className="mt-7 text-center text-sm text-muted-foreground">Need access? <Link href="/contact" className="font-semibold text-primary hover:underline">Contact your programme team</Link></p></div></div>
      </div>
    </section>
  );
}